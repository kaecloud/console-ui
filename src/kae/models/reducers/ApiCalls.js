...
function genHandlers() {
  ...
  const apiTypes = [
    ...
    'GET_APP_CANARY_REQUEST', 'GET_APP_DEPLOYMENT_REQUEST', 'GET_APP_INGRESS_REQUEST',
    'GET_APP_RELEASES_REQUEST', 'GET_APP_LOGS_REQUEST',
    'LIST_APP_YAML_REQUEST', 'LIST_APP_DEPLOY_VERSION_REQUEST',
    ...
    'GET_APP_YAML_REQUEST', 'GET_APP_GRAFANA_DASHBOARD_REQUEST',
